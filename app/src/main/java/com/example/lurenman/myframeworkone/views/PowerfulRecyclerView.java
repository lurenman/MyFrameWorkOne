package com.example.lurenman.myframeworkone.views;
...
import com.example.lurenman.myframeworkone.utils.DensityUtil;
...
public class PowerfulRecyclerView extends RecyclerView {
    ...
    public PowerfulRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        mDividerSize = ta.getDimensionPixelSize(R.styleable.PowerfulRecyclerView_dividerSize, DensityUtil.dip2px(context, 1));
